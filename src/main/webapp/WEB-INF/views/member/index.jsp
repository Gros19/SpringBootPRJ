...
<head>
    ...
    <!-- Title -->
    <title>Maxwell Admin Template - Admin Dashboard</title>
    ...
    <nav id="sidebar" class="sidebar-wrapper">
        ...
        <div class="sidebar-brand">
            <a href="index.html" class="logo">
                <img src="bootstrap.gallery/maxwell/designs/gradient-version/img/logo.png" alt="Maxwell Admin" />
            </a>
        </div>
        <!-- Sidebar brand end  -->
                    ...
                    <li class="sidebar-dropdown">
                        ...
                        <div class="sidebar-submenu">
                            <ul>
                                ...
                                <li>
                                    <a href="layout-option1.html">Layout Option 1</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="layout-daterange.html">Layout Daterange</a>
                                </li>
                                <li>
                ...
                <ul class="header-actions">
                    ...
                    <li class="dropdown user-settings">
                        <a href="#" id="userSettings" data-toggle="dropdown" aria-haspopup="true">
                            <img src="img/user.png" class="user-avatar" alt="Avatar">
                        </a>
                            ...
                            <div class="customScroll5">
                                <div class="timeline-activity">
                                    <div class="activity-log">
                                        ...
                                        <div class="log-details">Maxwell dashboard has been created<span class="text-success ml-1">#New</span></div>
                                    </div>
                                    <div class="activity-log">
                                ...
                                <div class="products-sold-container">
                                    <div class="product">
                                        <div class="product-details">
                                            <img src="img/mob1.jpg" alt="Apple iPhone 11">
...
<!-- Mirrored from bootstrap.gallery/maxwell/designs/gradient-version/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Apr 2022 21:43:52 GMT -->
</html>
